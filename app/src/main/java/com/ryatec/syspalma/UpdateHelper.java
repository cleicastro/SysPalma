    ...
    private class GetLatestVersion extends AsyncTask<String, String, String> {
        ...
        protected void onPostExecute(String s) {
            ...
            if(!currentVersion.equals(latestVersion)&&latestVersion!=null){
                ...
                builder.setTitle("Uma nova versão disponível");
                builder.setMessage("Antes de tualizar envie todos seus dados armazenados no dispositivo, você deseja atualizar agora?");
                builder.setPositiveButton("Atualizar", new DialogInterface.OnClickListener() {
                    @Override
                    public void onClick(DialogInterface dialog, int which) {
                        //Click button action
                        activity.startActivity(new Intent(Intent.ACTION_VIEW, Uri.parse("market://details?id="+activity.getPackageName())));
                        //activity.startActivity(new Intent(Intent.ACTION_VIEW, Uri.parse("syspalma.com/SysPalma.apk")));
                        dialog.dismiss();
                    }
                });
                ...
                if (manualCheck) {
                    Toast.makeText(activity, "Nenhuma atualização disponível", Toast.LENGTH_SHORT).show();
                }
            }
        }
        @Override
        protected void onPreExecute() {
            ...
            if (manualCheck) {
                ...
                progressDialog.setMessage("Verificando atualização.....");
